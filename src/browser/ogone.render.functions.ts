...
Ogone.renderSlots = function (Onode: HTMLOgoneElement) {
  const o = Onode.ogone;
  if (!o.nodes) return;
...
Ogone.renderNode = function (Onode: HTMLOgoneElement) {
...
Ogone.renderStore = function (Onode: HTMLOgoneElement) {
  const o = Onode.ogone, oc = o.component;
  if (!oc) return;
  if (oc.namespace !== o.namespace) {
    ...
    Ogone.displayError(error, "Store Module: Bad Namsepace Exception", {
      message: `
...
Ogone.renderRouter = function (Onode: HTMLOgoneElement) {
  const o = Onode.ogone, oc = o.component;
  if (!oc) return;
...
Ogone.renderAsyncRouter = function (Onode: HTMLOgoneElement) {
  const o = Onode.ogone;
  if (!o.nodes) return;
...
Ogone.renderAsyncStores = function (Onode: HTMLOgoneElement) {
  const o = Onode.ogone;
  if (!o.nodes) return;
...
Ogone.renderComponent = function (Onode: HTMLOgoneElement) {
  const o = Onode.ogone;
  if (!o.nodes) return;
...
Ogone.renderAsync = function (Onode: HTMLOgoneElement, shouldReportToParentComponent: boolean) {
  const o = Onode.ogone, oc = o.component;
  if (!oc) return;
...
Ogone.renderingProcess = function (Onode: HTMLOgoneElement) {
  const o = Onode.ogone;
...
Ogone.renderContext = function (Onode: HTMLOgoneElement) {
  const o = Onode.ogone, oc = o.component;
...
Ogone.saveUntilRender = function (Onode: HTMLOgoneElement, f: Function): void {
