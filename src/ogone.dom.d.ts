...
/** A generic export interface for representing an audio processing module. Examples include: */
...
/** The Web Audio API's AudioParam export interface represents an audio-related parameter, usually a parameter of an AudioNode (such as GainNode.gain). */
...
/** Provides a storage mechanism for Request / Response object pairs that are cached, for example as part of the ServiceWorker life cycle. Note that the Cache export interface is exposed to windowed scopes as well as workers. You don't have to use it in conjunction with service workers, even though it is defined in the service worker spec. */
...
/** The ChannelMergerNode export interface, often used in conjunction with its opposite, ChannelSplitterNode, reunites different mono inputs into a single output. Each input is used to fill a channel of the output. This is useful for accessing each channels separately, e.g. for performing channel mixing where gain must be separately controlled on each channel. */
...
/** The ChannelSplitterNode export interface, often used in conjunction with its opposite, ChannelMergerNode, separates the different channels of an audio source into a set of mono outputs. This is useful for accessing each channel separately, e.g. for performing channel mixing where gain must be separately controlled on each channel. */
...
/** The CharacterData abstract export interface represents a Node object that contains characters. This is an abstract export interface, meaning there aren't any object of export type CharacterData: it is implemented by other export interfaces, like Text, Comment, or ProcessingInstruction which aren't abstract. */
...
/** A export type returned by some APIs which contains a list of DOMString (strings). */
...
export interface DataTransferItemList {
    ...
    readonly length: number;
    /**
     * Adds a new entry for the given data to the drag data store. If the data is plain text then a export type string has to be provided also.
     */
...
export interface Document extends Node, DocumentAndElementEventHandlers, DocumentOrShadowRoot, GlobalEventHandlers, NonElementParentNode, ParentNode, XPathEvaluatorBase {
    ...
    /**
     * Returns document's content export type.
     */
    ...
    dir: string;
    /**
     * Gets an object representing the document export type declaration associated with the current document.
     */
     ...
     * @param whatToShow The export type of nodes or elements to appear in the node list
     ...
     * @param root The root element or node to start traversing on.
     * @param whatToShow The export type of nodes or elements to appear in the node list. For more information, see whatToShow.
     ...
     * @param showUI Display the user export interface, defaults to false.
     ...
     * @param url Specifies a MIME export type for the document.
...
/** An object of this export type is returned by the files property of the HTML <input> element; this lets you access the list of files selected with the <input export type="file"> element. It's also used for a list of files dropped into web content when using the drag and drop API; see the DataTransfer object for details on this usage. */
...
/** This Gamepad API export interface represents the pose of a WebVR controller at a given timestamp (which includes orientation, position, velocity, and acceleration information.) */
...
/** Hyperlink elements and provides special properties and methods (beyond those of the regular HTMLElement object export interface that they inherit from) for manipulating the layout and presentation of such elements. */
...
/** Provides special properties and methods (beyond those of the regular object HTMLElement export interface it also has available to it by inheritance) for manipulating the layout and presentation of <area> elements. */
...
/** Provides access to the properties of <audio> elements, as well as methods to manipulate them. It derives from the HTMLMediaElement export interface. */
...
/** Contains the base URI for a document. This object inherits all of the properties and methods as described in the HTMLElement export interface. */
...
/** Provides special properties (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating <basefont> elements. */
...
/** Provides special properties (beyond those inherited from the regular HTMLElement export interface) for manipulating <body> elements. */
...
/** Provides properties and methods (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating <button> elements. */
export interface HTMLButtonElement extends HTMLElement {
    ...
    formMethod: string;
    /**
     * Overrides any validation or required attributes on a form or form elements to allow it to be submitted without validation. This can be used to create a "save draft"-export type submit option.
     */
...
/** Provides properties and methods for manipulating the layout and presentation of <canvas> elements. The HTMLCanvasElement export interface also inherits the properties and methods of the HTMLElement export interface. */
export interface HTMLCanvasElement extends HTMLElement {
     ...
     * @param contextId The identifier (ID) of the export type of canvas to create. Internet Explorer 9 and Internet Explorer 10 support only a 2-D context using canvas.getContext("2d"); IE11 Preview also supports 3-D or WebGL context using canvas.getContext("experimental-webgl");
     */
     ...
     * @param export type The standard MIME export type for the image format to return. If you do not specify this parameter, the default value is a PNG format image.
     */
...
/** Provides special properties (beyond those of the regular HTMLElement export interface it also has available to it by inheritance) for manipulating definition list (<dl>) elements. */
...
/** Provides special properties (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating <data> elements. */
...
/** Provides special properties (beyond the HTMLElement object export interface it also has available to it by inheritance) to manipulate <datalist> elements and their content. */
...
/** Provides special properties (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating <div> elements. */
...
/** Provides special properties (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating <embed> elements. */
...
/** Provides special properties and methods (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating the layout and presentation of <fieldset> elements. */
...
export interface HTMLFormElement extends HTMLElement {
    ...
    encoding: string;
    /**
     * Sets or retrieves the encoding export type for the form.
     */
    enctype: string;
    /**
     * Sets or retrieves the number of objects in a collection.
...
/** Provides special properties (beyond those of the regular HTMLElement export interface they also inherit) for manipulating <frameset> elements. */
...
/** Provides special properties (beyond those of the HTMLElement export interface it also has available to it by inheritance) for manipulating <hr> elements. */
...
/** Contains the descriptive information, or metadata, for a document. This object inherits all of the properties and methods described in the HTMLElement export interface. */
...
/** The different heading elements. It inherits methods and properties from the HTMLElement export interface. */
...
/** Serves as the root node for a given HTML document. This object inherits the properties and methods described in the HTMLElement export interface. */
...
/** Provides special properties and methods (beyond those of the HTMLElement export interface it also has available to it by inheritance) for manipulating the layout and presentation of inline frame elements. */
...
export interface HTMLInputElement extends HTMLElement {
    ...
    disabled: boolean;
    /**
     * Returns a FileList object on a file export type input object.
     */
    files: FileList | null;
    /**
     * Retrieves a reference to the form that the object is embedded in.
    ...
    /**
     * Defines the maximum acceptable value for an input element with export type="number".When used with the min and step attributes, lets you control the range and increment (such as only even numbers) that the user can enter into an input field.
     */
    max: string;
    /**
    ...
    maxLength: number;
    /**
     * Defines the minimum acceptable value for an input element with export type="number". When used with the max and step attributes, lets you control the range and increment (such as even numbers only) that the user can enter into an input field.
     */
    min: string;
    minLength: number;
    /**
    ...
    pattern: string;
    /**
     * Gets or sets a text string that is displayed in an input field as a hint or prompt to users as the format or export type of information they need to enter.The text appears in an input field until the user puts focus on the field.
     */
    placeholder: string;
    readOnly: boolean;
    /**
    ...
    step: string;
    /**
     * Returns the content export type of the object.
     */
    type: string;
    /**
     * Sets or retrieves the URL, often with a bookmark extension (#name), to use as a client-side image map.
...
/** Exposes specific properties and methods (beyond those defined by regular HTMLElement export interface it also has available to it by inheritance) for manipulating list elements. */
...
/** Gives access to properties specific to <label> elements. It inherits methods and properties from the base HTMLElement export interface. */
...
/** The HTMLLegendElement is an export interface allowing to access properties of the <legend> elements. It inherits properties and methods from the HTMLElement export interface. */
...
/** Reference information for external resources and the relationship of those resources to a document and vice-versa. This object inherits all of the properties and methods of the HTMLElement export interface. */
export interface HTMLLinkElement extends HTMLElement, LinkStyle {
    ...
    integrity: string;
    /**
     * Sets or retrieves the media export type.
     */
    media: string;
    referrerPolicy: string;
    /**
    ...
    target: string;
    /**
     * Sets or retrieves the MIME export type of the object.
     */
    type: string;
...
/** Provides special properties and methods (beyond those of the regular object HTMLElement export interface it also has available to it by inheritance) for manipulating the layout and presentation of map elements. */
...
export interface HTMLMediaElement extends HTMLElement {
    ...
    /**
     * Returns a string that specifies whether the client can play a given media resource export type.
     */
...
/** Contains descriptive metadata about a document. It inherits all of the properties and methods described in the HTMLElement export interface. */
...
/** The HTML <meter> elements expose the HTMLMeterElement export interface, which provides special properties and methods (beyond the HTMLElement object export interface they also have available to them by inheritance) for manipulating the layout and presentation of <meter> elements. */
...
/** Provides special properties (beyond the regular methods and properties available through the HTMLElement export interface they also have available to them by inheritance) for manipulating modification elements, that is <del> and <ins>. */
...
/** Provides special properties (beyond those defined on the regular HTMLElement export interface it also has available to it by inheritance) for manipulating ordered list elements. */
...
/** Provides special properties and methods (beyond those on the HTMLElement export interface it also has available to it by inheritance) for manipulating the layout and presentation of <object> element, representing external resources. */
export interface HTMLObjectElement extends HTMLElement {
    ...
    codeBase: string;
    /**
     * Sets or retrieves the Internet media export type for the code associated with the object.
     */
    /** @deprecated */
    codeType: string;
    /**
...
/** Provides special properties and methods (beyond the regular HTMLElement object export interface they also have available to them by inheritance) for manipulating the layout and presentation of <optgroup> elements. */
...
/** <option> elements and inherits all classes and methods of the HTMLElement export interface. */
...
/** HTMLOptionsCollection is an export interface representing a collection of HTML option elements (in document order) and offers methods and properties for traversing the list as well as optionally altering its items. This export type is returned solely by the "options" property of select. */
...
/** Provides special properties (beyond those of the regular HTMLElement object export interface it inherits) for manipulating <p> elements. */
...
/** Provides special properties (beyond those of the regular HTMLElement object export interface it inherits) for manipulating <param> elements, representing a pair of a key and a value that acts as a parameter for an <object> element. */
export interface HTMLParamElement extends HTMLElement {
    ...
    name: string;
    /**
     * Sets or retrieves the content export type of the resource designated by the value attribute.
     */
    /** @deprecated */
    type: string;
    /**
    ...
    value: string;
    /**
     * Sets or retrieves the data export type of the value attribute.
     */
    /** @deprecated */
    valueType: string;
...
/** Exposes specific properties and methods (beyond those of the HTMLElement export interface it also has available to it by inheritance) for manipulating a block of preformatted text (<pre>). */
...
/** Provides special properties and methods (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating the layout and presentation of <progress> elements. */
...
/** Provides special properties and methods (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating quoting elements, like <blockquote> and <q>, but not the <cite> element. */
...
/** HTML <script> elements expose the HTMLScriptElement export interface, which provides special properties and methods for manipulating the behavior and execution of <script> elements (beyond the inherited HTMLElement export interface). */
export interface HTMLScriptElement extends HTMLElement {
    ...
    text: string;
    /**
     * Sets or retrieves the MIME export type for the associated scripting engine.
     */
    type: string;
...
/** A <select> HTML Element. These elements also share all of the properties and methods of other HTML elements via the HTMLElement export interface. */
export interface HTMLSelectElement extends HTMLElement {
    ...
    size: number;
    /**
     * Retrieves the export type of select control based on the value of the MULTIPLE attribute.
     */
    readonly type: string;
    /**
     * Returns the error message that would be displayed if the user submits the form, or an empty string if no error message. It also triggers the standard error message, such as "this is a required field". The result is that the user sees validation messages without actually submitting.
     ...
     * @param element Variant of export type Number that specifies the index position in the collection where the element is placed. If no value is given, the method places the element at the end of the collection.
     * @param before Variant of export type Object that specifies an element to insert before, or null to append the object to the collection.
     */
    add(element: HTMLOptionElement | HTMLOptGroupElement, before?: HTMLElement | number | null): void;
    /**
     * Returns whether a form will validate when it is submitted, without having to submit it.
    ...
    /**
     * Retrieves a select object or an object from an options collection.
     * @param name Variant of export type Number or String that specifies the object or collection to retrieve. If this parameter is an integer, it is the zero-based index of the object. If this parameter is a string, all objects with matching name or id properties are retrieved, and a collection is returned if more than one match is made.
     * @param index Variant of export type Number that specifies the zero-based index of the object to retrieve when a collection is returned.
     */
    item(index: number): Element | null;
    /**
     * Retrieves a select object or an object from an options collection.
...
/** Provides special properties (beyond the regular HTMLElement object export interface it also has available to it by inheritance) for manipulating <source> elements. */
export interface HTMLSourceElement extends HTMLElement {
    /**
     * Gets or sets the intended media export type of the media source.
     */
    media: string;
    sizes: string;
    /**
    ...
    srcset: string;
    /**
     * Gets or sets the MIME export type of a media resource.
     */
    type: string;
...
/** A <span> element and derives from the HTMLElement export interface, but without implementing any additional properties or methods. */
...
/** Special properties (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating table caption elements. */
...
/** Provides special properties and methods (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating the layout and presentation of table cells, either header or data cells, in an HTML document. */
...
/** Provides special properties (beyond the HTMLElement export interface it also has available to it inheritance) for manipulating single or grouped table column elements. */
...
/** Provides special properties and methods (beyond the regular HTMLElement object export interface it also has available to it by inheritance) for manipulating the layout and presentation of tables in an HTML document. */
...
/** Provides special properties and methods (beyond the HTMLElement export interface it also has available to it by inheritance) for manipulating the layout and presentation of rows in an HTML table. */
...
/** Provides special properties and methods (beyond the HTMLElement export interface it also has available to it by inheritance) for manipulating the layout and presentation of sections, that is headers, footers and bodies, in an HTML table. */
...
export interface HTMLTextAreaElement extends HTMLElement {
    ...
    /**
     * Retrieves the export type of control.
     */
    readonly type: string;
    /**
     * Returns the error message that would be displayed if the user submits the form, or an empty string if no error message. It also triggers the standard error message, such as "this is a required field". The result is that the user sees validation messages without actually submitting.
...
/** Provides special properties (beyond the regular HTMLElement export interface it also has available to it by inheritance) for manipulating <time> elements. */
...
/** Contains the title for a document. This element inherits all of the properties and methods of the HTMLElement export interface. */
...
/** Provides special properties (beyond those defined on the regular HTMLElement export interface it also has available to it by inheritance) for manipulating unordered list elements. */
...
/** An invalid HTML element and derives from the HTMLElement export interface, but without implementing any additional properties or methods. */
...
/** This IndexedDB API export interface represents a cursor for traversing or iterating over multiple records in a database. */
...
/** This IndexedDB API export interface represents a cursor for traversing or iterating over multiple records in a database. It is the same as the IDBCursor, except that it includes the value property. */
...
/** This IndexedDB API export interface provides a connection to a database; you can use an IDBDatabase object to open a transaction on your database then create, manipulate, and delete objects (data) in that database. The export interface provides the only way to get and manage versions of the database. */
...
/** IDBIndex export interface of the IndexedDB API provides asynchronous access to an index in a database. An index is a kind of object store for looking up records in another object store, called the referenced object store. You use this export interface to retrieve data. */
...
/** This IndexedDB API export interface indicates that the version of the database has changed, as the result of an IDBOpenDBRequest.onupgradeneeded event handler function. */
...
/** The MSGestureEvent is a proprietary export interface specific to Internet Explorer and Microsoft Edge which represents events that occur due to touch gestures. Events using this export interface include MSGestureStart, MSGestureEnd, MSGestureTap, MSGestureHold, MSGestureChange, and MSInertiaStart. */
...
/** This EncryptedMediaExtensions API export interface contains the content and related data when the content decryption module generates a message for the session. */
...
/** This EncryptedMediaExtensions API export interface represents a context for message exchange with a content decryption module (CDM). */
...
/** This EncryptedMediaExtensions API export interface is a read-only map of media key statuses by key IDs. */
...
/** This EncryptedMediaExtensions API export interface the represents a set of keys that an associated HTMLMediaElement can use for decryption of media data during playback. */
...
/** This Media Source Extensions API export interface represents a source of media data for an HTMLMediaElement object. A MediaSource object can be attached to a HTMLMediaElement to be played in the user agent. */
...
/** A export type of AudioNode which operates as an audio source whose media is received from a MediaStream obtained using the WebRTC or Media Capture and Streams APIs. */
...
/** Events that occurs in relation to a MediaStream. Two events of this export type can be thrown: addstream and removestream. */
...
/** This Channel Messaging API export interface allows us to create a new message channel and send data through it via its two MessagePort properties. */
...
/** This Channel Messaging API export interface represents one of the two ports of a MessageChannel, allowing messages to be sent from one port and listening out for them arriving at the other. */
...
/** Events that occur due to the user interacting with a pointing device (such as a mouse). Common events using this export interface include click, dblclick, mouseup, mousedown. */
...
export interface MutationRecord {
    ...
    /**
     * The return value depends on export type. For "attributes", it is the value of the changed attribute before the change. For "characterData", it is the data of the changed node before the change. For "childList", it is null.
     */
    ...
    /**
     * Returns the node the mutation affected, depending on the export type. For "attributes", it is the element whose attribute changed. For "characterData", it is the CharacterData node. For "childList", it is the node whose children changed.
     */
...
/** Node is an export interface from which a number of DOM API object types inherit. It allows those types to be treated similarly; for example, inheriting the same set of methods, or being tested in the same way. */
export interface Node extends EventTarget {
    ...
    /**
     * Returns a string appropriate for the export type of node.
     */
    readonly nodeName: string;
    /**
     * Returns the export type of node.
     */
...
/** The Web Audio API OfflineAudioCompletionEvent export interface represents events that occur when the processing of an OfflineAudioContext is terminated. The complete event implements this export interface. */
...
/** An AudioContext export interface representing an audio-processing graph built from linked together AudioNodes. In contrast with a standard AudioContext, an OfflineAudioContext doesn't render the audio to the device hardware; instead, it generates it, as fast as it can, and outputs the result to an AudioBuffer. */
...
export interface OffscreenCanvas extends EventTarget {
     ...
     *
     * The argument, if provided, is a dictionary that controls the encoding options of the image file to be created. The export type field specifies the file format and has a default value of "image/png"; that export type is also used if the requested export type isn't supported. If the image format supports variable quality (such as "image/jpeg"), then the quality field is a number in the range 0.0 to 1.0 inclusive indicating the desired quality level for the resulting image.
     */
     ...
     *
     * Returns null if the canvas has already been initialized with another context export type (e.g., trying to get a "2d" context after getting a "webgl" context).
     */
...
/** The OscillatorNode export interface represents a periodic waveform, such as a sine wave. It is an AudioScheduledSourceNode audio-processing module that causes a specified frequency of a given wave to be created—in effect, a constant tone. */
...
/** This Canvas 2D API export interface is used to declare a path that can then be used on a CanvasRenderingContext2D object. The path methods of the CanvasRenderingContext2D export interface are also present on this export interface, which gives you the convenience of being able to retain and replay your path whenever desired. */
...
/** This Payment Request API export interface is the primary access point into the API, and lets web content and apps accept payments from the end user. */
...
/** Provides methods and properties to store and retrieve metrics regarding the browser's document navigation events. For example, this export interface can be used to determine how much time it takes to load or unload a document. */
...
/** The state of a DOM event produced by a pointer such as the geometry of the contact point, the device export type that generated the event, the amount of pressure that was applied on the contact surface, etc. */
...
/** This Push API export interface provides a way to receive notifications from third-party servers as well as request URLs for push notifications. */
...
/** Events sent to indicate that DTMF tones have started or finished playing. This export interface is used by the tonechange event. */
...
/** Used for attributes of basic export type <angle> which can be animated. */
...
/** Used for attributes of export type boolean which can be animated. */
...
/** Used for attributes of basic export type <integer> which can be animated. */
...
/** Used for attributes of basic export type <length> which can be animated. */
...
/** Used for attributes of export type SVGLengthList which can be animated. */
...
/** Used for attributes of basic export type <Number> which can be animated. */
...
/** Used for attributes of export type SVGPreserveAspectRatio which can be animated. */
...
/** An export interface for the <circle> element. The circle element is defined by the cx and cy attributes that denote the coordinates of the centre of the circle. */
...
/** A base export interface used by the component transfer function export interfaces. */
...
/** All of the SVG DOM export interfaces that correspond directly to elements in the SVG language derive from the SVGElement export interface. */
...
/** The SVGGradient export interface is a base export interface used by SVGLinearGradientElement and SVGRadialGradientElement. */
...
/** Correspond to the <length> basic data export type. */
...
/** Corresponds to the <number> basic data export type. */
...
/** Provides access to the properties of <svg> elements, as well as methods to manipulate them. This export interface contains also various miscellaneous commonly-used utility methods, such as matrix operations and the ability to control the time of redraw on visual rendering devices. */
...
/** Implemented by elements that support rendering child text content. It is inherited by various text-related export interfaces, such as SVGTextElement, SVGTSpanElement, SVGTRefElement, SVGAltGlyphElement and SVGTextPathElement. */
...
/** SVGTransform is the export interface for one of the component transformations within an SVGTransformList; thus, an SVGTransform object corresponds to a single component (e.g., scale(…) or matrix(…)) within a transform attribute. */
...
/** Used to reflect the zoomAndPan attribute, and is mixed in to other export interfaces for elements that support this attribute. */
...
/** This ServiceWorker API export interface provides a reference to a service worker. Multiple browsing contexts (e.g. pages, workers, etc.) can be associated with the same service worker, each through a unique ServiceWorker object. */
...
/** The ServiceWorkerContainer export interface of the ServiceWorker API provides an object representing the service worker as an overall unit in the network ecosystem, including facilities to register, unregister and update service workers, and access the state of service workers and their registrations. */
...
/** This ServiceWorker API export interface contains information about an event sent to a ServiceWorkerContainer target. This extends the default message event to allow setting a ServiceWorker object as the source of a message. The event object is accessed via the handler function of a message event, when fired by a message received from a service worker. */
...
/** This Web Speech API export interface is the controller export interface for the speech service; this can be used to retrieve information about the synthesis voices available on the device, start and pause speech, and other commands besides. */
...
/** This Web Speech API export interface represents a speech request. It contains the content the speech service should read and information about how to read it (e.g. language, pitch and volume.) */
...
/** This Web Storage API export interface provides access to a particular domain's session or local storage. It allows, for example, the addition, modification, or deletion of stored data items. */
...
/** This ServiceWorker API export interface provides an export interface for registering and listing sync registrations. */
...
/** This export interface also inherits properties from EventTarget. */
export interface TextTrack extends EventTarget {
    ...
    readonly id: string;
    /**
     * Returns the text track in-band metadata track dispatch export type string.
     */
...
/** This WebVR API export interface describes the capabilities of a VRDisplay — its features can be used to perform VR device capability tests, for example can it return position information. */
...
/** This WebVR API export interface represents represents the event object of WebVR-related events (see the list of WebVR window extensions). */
...
/** This WebVR API export interface represents a field of view defined by 4 different degree values describing the view from a center point. */
...
/** This WebVR API export interface represents the state of a VR sensor at a given timestamp (which includes orientation, position, velocity, and acceleration information.) */
...
/** The WebContextEvent export interface is part of the WebGL API and is an export interface for an event that is generated in response to a status change to the WebGL rendering context. */
...
/** Provides an export interface to the OpenGL ES 2.0 graphics rendering context for the drawing surface of an HTML <canvas> element. */
...
/** This Streams API export interface is the object returned by WritableStream.getWriter() and once created locks the < writer to the WritableStream ensuring that no other streams can write to the underlying sink. */
...
export interface XMLHttpRequest extends XMLHttpRequestEventTarget {
    ...
    /**
     * Returns the response export type.
     *
...
/** Holds useful CSS-related methods. No object with this export interface are implemented: it contains only static methods and therefore is a utilitarian export interface. */
